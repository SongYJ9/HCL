...
if __name__ == "__main__":
    ...
    def train(epoch, net, net2, optimizer, labeled_trainloader, unlabeled_trainloader, args):
        ...
        ### CHANGE: add a new function "step" to facilitate HCL-Mix calculation
        ...
        HCL_Mix_labeled_trainloader, HCL_Mix_unlabeled_trainloader = loader.run(
            "train", pred2, prob2
        )  # co-divide

        print("\nHCL mix training:")
        step(epoch, net, net2, optimizer, HCL_Mix_labeled_trainloader, HCL_Mix_unlabeled_trainloader, args)
