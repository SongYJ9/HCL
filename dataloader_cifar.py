    ...
    def __init__(
        ...
        if self.mode == "test":
            ...
            if self.mode == "all":
                ...
                ### CHANGE: don't want to look that
...
class cifar_dataloader:
    ...
    def run(self, mode, pred=[], prob=[]):
        ...
        ### ADD: hard label trainloader
        elif mode == "hard":
            hard_dataset = cifar_dataset(
                dataset=self.dataset,
                noise_mode=self.noise_mode,
                r=self.r,
                root_dir=self.root_dir,
